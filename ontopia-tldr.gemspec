# -*- encoding: utf-8 -*-
# stub: ontopia-tldr 0.0.4 java lib
...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--title", "ontopia-tldr Application documentation (v0.0.4)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<midos>, [">= 0"])
      s.add_runtime_dependency(%q<ontopia-topicmaps>, [">= 0"])
      s.add_runtime_dependency(%q<sinatra-bells>, [">= 0"])
      s.add_development_dependency(%q<hen>, [">= 0"])
      s.add_development_dependency(%q<rake>, [">= 0"])
    else
      s.add_dependency(%q<midos>, [">= 0"])
      s.add_dependency(%q<ontopia-topicmaps>, [">= 0"])
      s.add_dependency(%q<sinatra-bells>, [">= 0"])
